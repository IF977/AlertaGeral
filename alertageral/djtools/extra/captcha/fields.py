...
from djtools.extra.captcha import client
from djtools.extra.captcha.widgets import ReCaptcha


class ReCaptchaField(forms.CharField):
    default_error_messages = {
        'captcha_invalid': _(u'Enter a valid value.')
    }
    ...
    def __init__(self, public_key=None, private_key=None, use_ssl=None, \
        ...
        """
        public_key = public_key or getattr(settings, 'RECAPTCHA_PUBLIC_KEY', '')
        self.private_key = private_key or getattr(settings, 'RECAPTCHA_PRIVATE_KEY', '')
